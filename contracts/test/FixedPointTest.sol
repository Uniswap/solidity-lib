...
contract FixedPointTest {
    function encode(uint112 x) external pure returns (FixedPoint.q112x112 memory) {
    ...
    function uqdiv(FixedPoint.q112x112 calldata self, uint112 y) external pure returns (FixedPoint.q112x112 memory) {
    ...
    function decode(FixedPoint.q112x112 calldata self) external pure returns (uint112) {
